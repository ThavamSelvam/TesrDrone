...
public class ActivityOtpVerificationBindingImpl extends ActivityOtpVerificationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ImgBackBtn, 3);
        sViewsWithIds.put(R.id.appCompatTextView, 4);
        sViewsWithIds.put(R.id.txtNote, 5);
        sViewsWithIds.put(R.id.txtOnNumber, 6);
        sViewsWithIds.put(R.id.txtOtpView, 7);
        sViewsWithIds.put(R.id.txtCodeNotReceived, 8);
    }
    // views
    @NonNull
    ...
    private ActivityOtpVerificationBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (in.aabhasjindal.otptextview.OtpTextView) bindings[7]
            );
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.project.dronedemo.view.otpverification.OtpVerificationViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.project.dronedemo.view.otpverification.OtpVerificationViewModel ViewModel) {
